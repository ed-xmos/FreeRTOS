...
#define testingmainENABLE_REG_TEST_TASKS				0

/* Death cannot be run with any demo that creates or destroys tasks */
#define testingmainENABLE_DEATH_TASKS					0
...
#define testingmainENABLE_QUEUE_OVERWRITE_TASKS			0
...
#define testingmainENABLE_TASK_NOTIFY_TASKS				0
